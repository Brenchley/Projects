      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-university"><?php echo $entry_university; ?></label>
            <div class="col-sm-10">
              <input type="text" name="university" value="<?php echo $university; ?>" placeholder="<?php echo $entry_university; ?>" id="input-university" class="form-control" />
            </div>
          </div>
         <!--  <div class="form-group required">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-campus"><?php echo $entry_campus; ?></label>
            <div class="col-sm-10">
              <input type="text" name="campus" value="<?php echo $campus; ?>" placeholder="<?php echo $entry_campus; ?>" id="input-campus" class="form-control" />
              <?php if ($error_campus) { ?>
