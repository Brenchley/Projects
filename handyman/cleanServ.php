              ...
              <div class="row .container">
                <div class="col-md-12">
                  ...
                  <form name="cleaningForm" method="post" class="form-horizontal col-md-offset-6" role="form">
                      <h4 class="header">BOOK YOUR CLEANING</h4>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7 input-group">
                        ...
                        <input id="datepicker" class="form-control input-small" type="date" name="date" required/>
...
$id = "SELECT id FROM `service_type` WHERE service_title = 'Cleaning' ";
