        ...
        <div class="container" style="margin-top:20px;">
          ...
          <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb ">
              ...
              <li class="active ">Electricals</li>
              </ul>
          </div>
            <div class="page-content ">
              ...
              <div class="row .container">
                <div class="col-md-12">
                  ...
                  <form name="cleaningForm" method="post" class="form-horizontal col-md-offset-6" role="form">
                      <h4 class="header">ELECTRICAL SERVICE</h4>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-7 input-group">
                        ...
                        <textarea  class="form-control  col-xs-12" rows="7" name="sdesc"></textarea> 
                      </div>
...
$id = "SELECT id FROM `service_type` WHERE service_title = 'Electricals' ";
